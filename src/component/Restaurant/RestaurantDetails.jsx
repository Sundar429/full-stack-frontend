...
function RestaurantDetails() {
    ...
    useEffect(()=>{
        dispatch(getMenuItemsByRestaurantId({jwt,restaurantId:id,vegetarian:foodType==="vegetarian",
    ...
    return (
        <div className='px-5 lg:px-20 '>
            <section>
                <h3 className='text-gray-500 py-2 mt-10'>Home/India/South Indian Fast Food/3</h3>
                <div>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} lg={6}>
                            <img className='w-full h-[40vh] object-cover' src="https://cdn.pixabay.com/photo/2016/11/29/05/07/breads-1867459_640.jpg" alt="" />
            ...
            <section className='pt-[2rem] lg:flex relative'>
                        ...
                        <div>
                            ...
                            <FormControl className='py-10 space-y-5 ' component={"fieldset"}>
                             ...
                             value={selectedCategory}
                                ...
                                >
                                    { restaurant.categories && restaurant.categories.map((item,index) =>
                                        <FormControlLabel
                ...
                <div className='space-y-5 lg:w-[80%] lg:pl-10'>
                  {menu.menuItems.map((item,index)=><MenuCard key={item.id}  item={item}/>)}
