...
export const getMenuItemsByRestaurantId = (reqData) => {
    ...
    return async (dispatch) => {
        ...
        try {
            const { data } = await api.get(`/api/food/restaurant/${reqData.restaurantId}?vegetarian=${reqData.vegetarian}&nonVeg=${reqData.nonVeg}&seasonal=${reqData.seasonal}&foodCategory=${reqData.foodCategory}`, {
                headers: {
            ...
            // console.log("menu item by restaurants ", reqData.foodCategory);
